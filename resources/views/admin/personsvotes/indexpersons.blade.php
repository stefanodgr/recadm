...
<div class="row py-lg-2">
    ...
    <div class="col-md-6">
        <a href="/personsvotes" class="btn btn-danger btn-lg float-md-right" role="button" aria-pressed="true">Cancelar</a>
    </div>
    </div>
</div>
    <!-- /.container-fluid -->
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Busque el militante al cual se le sera cargada <strong>Centro Votación</strong> .</h6>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <td >
                <a href="/personsvotes/{{$person->id }}/create" type="button" class="btn btn-primary btn-sm">Cargar Centro</a>
