                ...
                <fieldset>
                    <div class="row">
                        ...
                        <div class="  form-group col-lg-5 col-md-3 col-xs-12 " >
                            <input type="text" name="Nombre" class="form-control" id="Nombre"  value="{{ $division->descripcion}}" title="Nombre">
                        </div>
                        ...
                        <div class="form-group text-left   col-lg-2 col-md-2 col-xs-5">
                            <a href="{{route('danger','divisions.index')}}" name="danger" type="button" class="btn btn-danger btn-block">Cancelar</a>
                        </div>
                    </div>
                </fieldset>
            </div>
