...
<body>
    ...
    <table width="200" >
        <tr>
            ...
            <td width="380"><h4>Listado de Militantes</h4></td>
        </tr>
    </table>
    <br>
    <br>
    ...
    <table   width="700px" border="1" style="font-size: 8px">
        <tr>
            ...
            <th align="center"  style="background-color:#0dc706;" >División</th>
            <th align="center"  style="background-color:#0dc706;" >Cargo</th>
            <th align="center"  style="background-color:#0dc706;" >Centro Votación</th>
            <th align="center"  style="background-color:#0dc706;" >Cargo Electoral</th>
          </tr>
        
          {{-- FILTRO ESTADO MUNICIPIO PARROQUIA --}}
          @if ( empty($personsPositions) && empty($personsDivisions) && !empty($persons))
          ...
          @if (!empty($personsDivisions))
            @foreach ($personsDivisions as $personsDivision)

                @foreach ($persons as $person)
                @if ( $personsDivision->person_id == $person->id   )
                    <tr>
          ...
          @if (!empty($personsPositions) && empty($personsDivisions))
            @foreach ($personsPositions as $personsPosition)
                    @foreach ($persons as $person)
                        @if ( $personsPosition->person_id == $person->id   )
                        <tr>
