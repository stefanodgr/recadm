...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Busque la persona que desea crearle un  <strong>Usuario</strong>.</h6>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <td >
                <a href="{{route('users.create',$person->id)}}" type="button" class="btn btn-primary btn-sm">Crear Usuario</a>
