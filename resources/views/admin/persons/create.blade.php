                        ...
                        <div class="col-12 ">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="xfecha_nace" name="Fecha_Nacimiento" value="{{$test->fecha}}" readonly>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select id="estado"  name="Estado" class="form-control">
                                         ...
                                         <option value="{{$estadosData->id}}">{{$estadosData->descripcion}}</option>
                                         @else
                                ...
                                <div class="form-group row">
                                    ...
                                    @if(Auth::user()->role_id  == '1')
                                        <option value="{{$municipiosData->id}}">{{$municipiosData->descripcion}}</option>
                                    @else
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="parroquia"  name="Parroquia" class="form-control" value="{{ old('Parroquia')}}" >
                                            @if(Auth::user()->role_id  == '1')
                                                <option value="{{$parroquiaData->id}}">{{$parroquiaData->descripcion}}</option>
                                            @else
