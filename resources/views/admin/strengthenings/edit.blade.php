                        ...
                        <div class="col-12 ">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" id="xnaci" name="Nacionalidad"  >
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="xcedula" name="Cedula" value="{{ $person->cedula}}" placeholder="Ej.00000000">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" id="xpri_name" name="Primer_Nombre" value="{{$person->nombre_pr}}" placeholder="Ej.Jose">
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" id="segundo nombre" name="Segundo_Nombre" value="{{$person->nombre_seg}}" placeholder="Ej.Manuel">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" id="xpri_ape" name="Primer_Apellido" value="{{$person->apellido_pr}}" placeholder="Ej.Fernandez" >
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" id="xseg_ape" name="Segundo_Apellido" value="{{$person->apellido_seg}}" placeholder="Ej.Perez">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" id="xfecha_nace" name="Fecha_Nacimiento" value="{{$person->fecha_nac}}">
                                    </div>
                                    <div class="col-sm-2">
                                        <label for="xgenero">Genero:</label>
                                    </div>
                                    <div class="col-sm-4">
                                        <select class="form-control" id="xgenero" name="Genero" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <a href="{{route('danger','persons.index')}}" name="danger" type="button" class="btn btn-danger btn-block">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
