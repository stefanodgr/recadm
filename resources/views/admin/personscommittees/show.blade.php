                ...
                <div class="container py-2">
                    <div class="row">
                        <div class="col-12 ">
                            ...
                            <hr>
                            <legend><strong>Datos del Comité</strong> </legend>
                            <hr>
                            <div class="form-group row">
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                              <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    <label for="Comites">Comites:</label>
                                </div>
                                <div class="col-sm-4">
                                    <select class="form-control" id="comite"  name="Comites" class="form-control" disabled >
                                        @foreach($localcommiteeData as $localcommiteeDat)
                                            @if ( $personscommittee->localcommitte_id == $localcommiteeDat->id)
                                                <option selected style="backgroud-color:blue;" value="{{$personscommittee->localcommitte_id}}"><strong>{{ $localcommiteeDat->descripcion }}</strong></option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4"  person>
                                    <textarea name="Observaciones" id="" cols="35" rows="3" value="{{$personscommittee->observaciones}}" disabled >{{$personscommittee->observaciones}}</textarea>
                                </div>
                                <div class="col-sm-2">
                                    <label for="Comites">Cargos:</label>
                                </div>
                                <div class="col-sm-4">
                                    <select class="form-control" id="comite"  name="Comites" class="form-control" disabled >
                                        @foreach($positions as $position)
                                            @if ( $personscommittee->position_id == $position->id)
                                                <option selected style="backgroud-color:blue;" value="{{$personscommittee->position_id}}"><strong>{{ $position->descripcion }}</strong></option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-sm-12">
                                        <a href="{{route('danger','personscommittees.index')}}" name="danger" type="button" class="btn btn-danger btn-block">Atras</a>
                                    </div>
                                </div>
                            </div>
                        </div>
